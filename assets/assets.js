...
export const infoList = [
    { icon: assets.code_icon, iconDark: assets.code_icon_dark, title: 'Languages', description: 'HTML, CSS, JavaScript, React.Js, Next.js, Redux, Redux-tollkit, ContextApi, Zustand, Yup, Zod and Axios.' },
    { icon: assets.edu_icon, iconDark: assets.edu_icon_dark, title: 'Education', description: 'Gopalganj Science and Technology University \n (B.Sc in Computer Science & Enginnering)' },
